...
<!-- Apply a conditional class based on the login status -->
<div class="home-content <?= (isset($isLoggedIn) && $isLoggedIn) ? 'with-sidebar' : 'no-sidebar'?>">
    <!-- Company Section -->
    ...
    <section id="hero" style="position: relative; overflow: hidden; width: 100%;">
        <div class="slider" style="display: flex; width: 100%;">
            <?php foreach ($heroSlides as $slide): ?>
                <div class="slide" style="flex: 1; background-image: url('<?= base_url('uploads/hero_images/' . esc($slide['image'])) ?>'); background-size: contain; background-repeat: no-repeat; background-position: right; height: 300px;">
    ...
    <section id="team">
        ...
        <div class="team-container" style="display: flex; flex-wrap: wrap; justify-content: space-around;">
            <?php foreach ($team as $member): ?>
                <div class="team-member" style="text-align: center; margin: 10px; flex: 1 1 150px; top:100px;">
    ...
    <section id="contact">
        ...
        <div id="map" style="width: 100%; height: 400px;">
            <iframe src="<?= esc($contact['map_location']) ?>" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
        </div>
    </section>
</div>
